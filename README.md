...
| Ascent | Dual of Descent: picks the largest minimal generator w with m < w < f and toggles it past f. After ascent the residue class of w has w + m as its new Apéry element. No-op when no eligible generator exists |
