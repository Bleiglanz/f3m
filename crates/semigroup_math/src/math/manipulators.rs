...
//! second `impl Semigroup` block to keep the [`super::semigroup`] module
//! focused on the data type and its inspectors.
...
impl Semigroup {
    ...
    #[must_use]
    fn destroy_atom(&self, a: usize) -> Self {
