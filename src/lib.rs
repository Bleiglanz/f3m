...
mod tests {
    ...
    fn test_20_44_54_73_77_89_90() {
        check(
            ...
            false,
            &[
                0, 121, 142, 143, 44, 165, 146, 127, 88, 89, 90, 131, 132, 73, 54, 175, 176, 77,
                98, 179,
            ],
    ...
    fn test_20_28_30_46_47() {
        check(
            ...
            false,
            &[
                0, 121, 102, 103, 84, 105, 46, 47, 28, 149, 30, 131, 92, 93, 74, 75, 56, 77, 58,
                139,
            ],
            &[85, 111, 119, 129],
            4,
    ...
    fn test_46_47_54_62_66_69_70_85() {
        check(
            ...
            &[
                ...
                156, 203, 66, 113, 160, 69, 70, 117, 164, 211, 120, 167, 214, 123, 124, 171, 218,
                265, 128, 175, 222, 85, 132, 179, 226, 135, 136, 183,
            ],
